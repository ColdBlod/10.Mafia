...
class MainActivity : ComponentActivity() {
    ...
    private lateinit var lst_init:Intent

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        lst_init = Intent(this, ListPlayersActivty::class.java)
    ...
    fun inizializate_lst_players(){
        this.lst_init.putExtra("is_clicked_players_lst", this.is_clicked_players_lst)
        this.lst_init.putExtra("players_size", this.players.size)
        startActivity(this.lst_init)
        if (false){
